...
class AttrationsScreen extends StatefulWidget {
  const AttrationsScreen({super.key});

  @override
  State<AttrationsScreen> createState() => _AttrationsScreenState();
}

class _AttrationsScreenState extends State<AttrationsScreen> {
